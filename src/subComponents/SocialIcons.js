...
const SocialIcons = (props) => {
    return (
        <Icons>
            ...
            >
                <NavLink style={{ color: 'inherit' }} targets="_blank" to={{ pathname: "https://github.com/harllogeen" }}>
            ...
            >
                <NavLink style={{ color: 'inherit' }} targets="_blank" to={{ pathname: "https://twitter.com/harllogeen1" }}>
